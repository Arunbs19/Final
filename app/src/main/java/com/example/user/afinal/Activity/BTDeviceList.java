...
// ex.fillInStackTrace();
    ...
    protected void onListItemClick(ListView l, View v, final int position, long id) {
        ...
        v.setBackgroundColor(getResources().getColor(R.color.backgrey));
        if (mBluetoothAdapter == null) {
            return;
        }
        ...
        Thread connectThread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                  ...
                  BTDeviceList.this.runOnUiThread(socketErrorRunnable);
                    try {
                        mbtSocket.close();
                    } catch (IOException e) {
                         //e.printStackTrace();
                    ...
                    BTDeviceList.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            finish();
